...
export default function About(){
    return(
        <React.Fragment>
            ...
            <p>HTML <img src={html} alt="html" width="50px" height="50px"/></p>
            <p>JavaScript <img src={js} alt="JS" width="50px" height="50px"/></p>
            <p>React <img src={react} alt="React" width="50px" height="50px"/></p>
            <p>Redux <img src={redux} alt="Redux" width="50px" height="50px"/></p>
            <p>Node <img src={node} alt="Node" width="50px" height="50px"/></p>
            <p>CSS <img src={css} alt="CSS" width="50px" height="50px"/></p>
            <p>Express <img src={express} alt="Express" width="50px" height="50px"/></p>
            <p>Postgres <img src={postgres} alt="Postgres" width="50px" height="50px"/></p>
            <p>Sequelize <img src={sequelize} alt="Sequelize" width="50px" height="50px"/></p>
            ...
            <p><a href="https://www.linkedin.com/in/franco-pressenda-163a81228/"> Linkedin  <img src={linkedin} alt="linkedin" width="50px" height="50px"/> </a></p>
            <p><a href="https://github.com/Francopress26">GitHub <img src={github} alt="linkedin" width="50px" height="50px"/> </a></p>
            <p>Tel +54 3436 615767  <img src={tel} alt="tel" width="30px" height="30px"/></p>
